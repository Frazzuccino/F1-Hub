...
- FIA — official steward/document source and official Car Presentation Submissions used for the Car Development section. F1 Hub derives broad component-location markers from the submission text; the schematic car drawings are original app UI and are not FIA/team CAD drawings.
