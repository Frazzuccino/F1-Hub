(function(root,factory){
  ...
  const ZONES=[
    ...
    {id:'floor-fences',label:'Floor fences / inlet',top:[236,139],side:[625,177],aliases:['floor fence','floor fences','floor furniture','floor inlet','floor leading edge','floor front','floor edge wing','forward floorboard','floorboard','floor board','board geometry']},
    ...
    {id:'cockpit',label:'Cockpit / halo',top:[320,158],side:[680,122],aliases:['halo','cockpit','mirror','rear view mirror','headrest']},
