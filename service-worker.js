const CACHE_NAME='f1-hub-v1.13.0';
const ASSETS=['./','./index.html','./manifest.json','./version.json','./icon.svg','./icon-192.png','./icon-512.png','./screenshot-standings.png','./screenshot-drivers.png','./styles.css?v=1.13.0','./quality-core.js?v=1.13.0','./car-development-core.js?v=1.13.0','./app.js?v=1.13.0'];
