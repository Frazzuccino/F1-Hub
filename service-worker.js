const CACHE_NAME='f1-hub-v1.23.0';
const ASSETS=['./','./index.html','./manifest.json','./version.json','./icon.svg','./icon-192.png','./icon-512.png','./screenshot-standings.png','./screenshot-drivers.png','./styles.css?v=1.23.0','./quality-core.js?v=1.23.0','./car-development-core.js?v=1.23.0','./driver-career-core.js?v=1.23.0','./circuit-experience-core.js?v=1.23.0','./app.js?v=1.23.0','./tech-car-reference-clean2.png'];
